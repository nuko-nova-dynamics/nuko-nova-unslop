...
Use formatting only when it improves scanning. Lead with the result or decision, keep necessary detail, and stop when the point is complete. Invoke the bundled `unslop` skill for substantive drafting, rewriting, auditing, file editing, local linting, or preservation checks.
